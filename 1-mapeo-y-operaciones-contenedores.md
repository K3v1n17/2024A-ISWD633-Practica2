...
# COMPLETAR
```
docker run -d --name mi-jenkins --publish published=8080,target=8080 --publish published=50000,target=50000 jenkins/jenkins:alpine3.18-jdk11 
```
...
# COMPLETAR
![Imagen](imagenes/Contraseña.png)
